...
export default function LoanPurchaseEntry() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-4">
      <h2 className="text-2xl font-bold mb-6 text-center">Product Purchase Entry</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white shadow rounded p-6">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          ...
          <div>
            <label className="block text-sm font-semibold mb-1">Exporter Name *</label>
           <select
            name="exporterName"
       ...
       <div className="flex flex-col md:flex-row gap-10">
        ...
        <h3 className="text-md font-semibold mb-2 text-sky-700">Download Template</h3>
